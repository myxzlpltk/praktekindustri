		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="progress mb-4">
					<div class="progress-bar bg-primary" role="progressbar" style="width: {{($statistik->total_mhs == 0)?0:($statistik->total_mhs / 427) * 100}}%" aria-valuenow="{{$statistik->total_mhs}}" aria-valuemin="0" aria-valuemax="427"></div>
				</div>
				...
				<div class="progress mb-4">
					<div class="progress-bar bg-warning" role="progressbar" style="width: {{($statistik->total_proposal == 0)?0:($statistik->pr_wait_koor / $statistik->total_proposal) * 100}}%" aria-valuenow="{{$statistik->pr_wait_koor}}" aria-valuemin="0" aria-valuemax="{{$statistik->total_proposal}}"></div>
				</div>
				...
				<div class="progress mb-4">
					<div class="progress-bar bg-warning" role="progressbar" style="width: {{($statistik->total_proposal == 0)?0:($statistik->pr_wait_kajur / $statistik->total_proposal) * 100}}%" aria-valuenow="{{$statistik->pr_wait_kajur}}" aria-valuemin="0" aria-valuemax="{{$statistik->total_proposal}}"></div>
				</div>

				<h4 class="small font-weight-bold">Proposal Ditolak oleh Koordinator <span class="float-right">{{$statistik->pr_tolak_koor}}</span></h4>
				<div class="progress mb-4">
					<div class="progress-bar bg-danger" role="progressbar" style="width: {{($statistik->total_proposal == 0)?0:($statistik->pr_tolak_koor / $statistik->total_proposal) * 100}}%" aria-valuenow="{{$statistik->pr_tolak_koor}}" aria-valuemin="0" aria-valuemax="{{$statistik->total_proposal}}"></div>
				</div>
				...
				<div class="progress mb-4">
					<div class="progress-bar bg-danger" role="progressbar" style="width: {{($statistik->total_proposal == 0)?0:($statistik->pr_tolak_kajur / $statistik->total_proposal) * 100}}%" aria-valuenow="{{$statistik->pr_tolak_kajur}}" aria-valuemin="0" aria-valuemax="{{$statistik->total_proposal}}"></div>
				</div>

				<h4 class="small font-weight-bold">Proposal Disahkan <span class="float-right">{{$statistik->pr_acc}}</span></h4>
				<div class="progress mb-4">
					<div class="progress-bar bg-success" role="progressbar" style="width: {{($statistik->total_proposal == 0)?0:($statistik->pr_acc / $statistik->total_proposal) * 100}}%" aria-valuenow="{{$statistik->pr_acc}}" aria-valuemin="0" aria-valuemax="{{$statistik->total_proposal}}"></div>
				</div>
